...
const Footer = () => {
  return (
    <>
      <div className=" text-white relative mt-40 ">
        <div className="container rounded-2xl mx-auto flex bg-white text-[var(--primary-color)]" style={{boxShadow: "30px 0px 60px rgba(128, 128, 128, 0.1)" }}>
          ...
          <div className="w-100 p-12 flex flex-col gap-4">
        ...
        <div className="mt-40" style={{ backgroundImage: 'url("https://html.themewant.com/invena/assets/images/footer/01.webp")', paddingTop: 80 }}>
