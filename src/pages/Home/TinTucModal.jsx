...
const TinTucModal = ({ isOpen, onClose, data, fetchData }) => {
  ...
  const onUpdate = async () => {
    ...
    let res
    if (data) {
      res = await SERVER.API.put(`/api/tin-tuc-va-su-kien`, formToSend);
    } else {
      res = await SERVER.API.post(`/api/tin-tuc-va-su-kien`, formToSend);
    }
        ...
        <div className="container mx-auto flex flex-col gap-10 p-4">
          ...
          <div className="col-span-2">
            <div className="flex flex-col gap-2">
              <b>Tag</b>
              <Input value={formData?.tag} onChange={(e) => setFormData({
                ...formData,
                tag: e.target.value,
              })}></Input>
              <b>Tiêu đề</b>
