    ...
    <div className="py-10">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 p-2">
          <div>
            <div className="font-bold text-2xl mb-2">Tin tức và sự kiện</div>
            <Swiper
                ...
                <SwiperSlide key={idx} className="relative  cursor-pointer" style={{ border: "1px solid #00000017" }}>
                  <div className="overflow-hidden">
                    <img
                      src={item.img}
                      alt={`Slide ${idx + 1}`}
                      className="w-full h-100 object-cover select-none transition-transform duration-300 ease-in-out transform hover:scale-105"
                    />
                  </div>
          ...
          <div>
            <div className="font-bold text-2xl mb-2">Lĩnh vực hoạt động</div>
            <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
              {data.linhvuchoatdong.map((item, idx) => (
                <div className="relative cursor-pointer">
                  <div className="overflow-hidden">
                    <img
                      src={item.img}
                      alt={`Slide ${idx + 1}`}
                      className="w-full h-48 object-cover select-none transition-transform duration-300 ease-in-out transform hover:scale-105"
                    />
                  </div>
